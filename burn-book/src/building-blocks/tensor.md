...
Burn tensors are defined by the number of dimensions `D` in their declarations rather than by their
shapes. The actual shape of a tensor is inferred from its initialization. For example, a tensor of size
